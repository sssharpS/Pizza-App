...
function tableBody() {
  ...
  //ajax request - it requires json data
...
function placeOrder(formObj) {
  //ajax request

  axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/orders', formObj).then(function (res) {
...
var itemsCount = document.querySelector('.countItems');
...
(0,_admin__WEBPACK_IMPORTED_MODULE_0__.tableBody)();
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    var curr_status = status.dataset.status;
    if (stepCompleted) {
...
function _initStripe() {
  _initStripe = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var stripe, card, mountWidget, paymentType, getForm;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_0__.loadStripe)("pk_test_51NoonVSEs4TN3ileSAbMvmvcKFe6q52uBatGycEEQDwGst4VtqfmlcfLOtuF5kmYoUX1tNaoZJLJV1XjK58nQ3Cs00Bxyf4hfd");
        case 3:
          stripe = _context.sent;
          card = null;
          paymentType = document.querySelector(".pay");
          if (paymentType) {
            _context.next = 8;
            break;
          }
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["assets/CSS/style"], () => (__webpack_require__("./resources/scss/style.scss")))
